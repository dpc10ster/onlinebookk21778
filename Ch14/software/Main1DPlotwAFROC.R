rm(list = ls()) # mainLinearPlotwAfroc.R
...
linearPlotwAFROC <- ggplot(data = ret) + geom_point(aes(x = ratings, y = pos, color = factor(truth), size = factor(weight))) + 
  ...
  annotation_custom(grob = textGrob(bquote(zeta),
                    ...
                    xmin = 3.2, xmax = 3.2, 
                    ymin = 0.35, ymax = 0.35) +
#   geom_segment(aes(x = 3.1, y = -0.4, xend = 3.1, yend = 0.4), linetype = 2) +
#   annotation_custom(grob = textGrob(bquote(zeta[R + 1] == +infinity),
#                                     gp = gpar(fontsize = 25)), 
#                     xmin = 3.1, xmax = 3.1, 
#                     ymin = -0.5, ymax = -0.5) +
#   geom_segment(aes(x = 2.5, y = -0.4, xend = 2.5, yend = 0.4), linetype = 2) +
#   annotation_custom(grob = textGrob(bquote(zeta[R]),
#                                     gp = gpar(fontsize = 25)), 
#                     xmin = 2.5, xmax = 2.5, 
#                     ymin = -0.5, ymax = -0.5) +
#   annotation_custom(grob = textGrob(bquote("... ... ... ..."),
#                                     gp = gpar(fontsize = 25)), 
#                     xmin = 2.05, xmax = 2.05, 
#                     ymin = -0.5, ymax = -0.5) +
#   geom_segment(aes(x = 1.62, y = -0.4, xend = 1.62, yend = 0.4), linetype = 2) +
#   annotation_custom(grob = textGrob(bquote(zeta[i + 1]),
#                                     gp = gpar(fontsize = 25)), 
#                     xmin = 1.62, xmax = 1.62, 
#                     ymin = -0.5, ymax = -0.5) +
#   geom_segment(aes(x = 0.7, y = -0.4, xend = 0.7, yend = 0.4), linetype = 2) +
...
#                     xmin = 0.1, xmax = 0.1, 
#                     ymin = -0.5, ymax = -0.5) +
#   geom_segment(aes(x = -0.5, y = -0.4, xend = -0.5, yend = 0.4), linetype = 2) +
#   annotation_custom(grob = textGrob(bquote(zeta[1]),
#                                     gp = gpar(fontsize = 25)), 
#                     xmin = -0.5, xmax = -0.5, 
#                     ymin = -0.5, ymax = -0.5) +
